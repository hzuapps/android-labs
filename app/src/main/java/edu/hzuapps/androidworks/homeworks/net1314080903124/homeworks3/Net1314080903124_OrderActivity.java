 ...
 * 
 */
public class Net1314080903124_OrderActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	private class QueryTask extends AsyncTask<Void, Void, ArrayList<Net1314080903124_CauseInfo>> {
		...
		protected ArrayList<Net1314080903124_CauseInfo> doInBackground(Void... params) {
			list = Net1314080903124_DBManager.getInstance(Net1314080903124_OrderActivity.this).query(Net1314080903124_AnswerColumns.TABLE_NAME);
			return list;
		}
		...
		protected void onPostExecute(ArrayList<Net1314080903124_CauseInfo> list) {
			...
			int lastSelect = Net1314080903124_ConfigPreferences.getInstance(Net1314080903124_OrderActivity.this).isLastSelectOrder();
			i = lastSelect - 1;
	...
	public void onClick(View v) {
		...
		case R.id.rel_help:
			if(TextUtils.isEmpty(answer.getText().toString().trim())){
				Toast.makeText(this, "答完本题才能查看题解！", Toast.LENGTH_SHORT).show();
				return;
			}
		...
		case R.id.back:
			...
			if (isClickSelectSubject) {
				i = Net1314080903124_ConfigPreferences.getInstance(this).isLastSelectOrder() - 1;
				i -= 1;
				isClickSelectSubject = false;
			} else {
				i -= 1;
			}
			Net1314080903124_ConfigPreferences.getInstance(this).setLastSelectOrder(i + 1);
		...
		case R.id.subject:
			listHasId = Net1314080903124_DBManager.getInstance(this).queryHasId(Net1314080903124_AnswerColumns.TABLE_NAME);
	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			tv.setText("" + listNumb.get(position).id);
			return convertView;
		}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		relFour.setBackgroundResource(R.color.select_default);
		i = position;
		Net1314080903124_ConfigPreferences.getInstance(this).setLastSelectOrder(position + 1);
