...
public class QueryByMouthActivity_Net1314080903221 extends Activity
{
	String[] bill_array=null;
	private ListView listView;
	private Map<Integer, Boolean> localmap;
	private Adapter_LS_Net1314080903221 myadapter;
	...
	private void fillList()
	{
			...
			myadapter=new Adapter_LS_Net1314080903221(this, list, localmap);
	  ...
	  public void onCreate(Bundle paramBundle)
	  {
	    ...
	    setContentView(R.layout.all_bill__net1314080903221);
	    fillList();
	  }
	  ...
	  public boolean onOptionsItemSelected(MenuItem paramMenuItem){
		  ...
		  /*
	        ...
	        consumeClass_Net1314080903221 trade=new consumeClass_Net1314080903221(0, 0, "", "123", "", QueryByMouthActivity_Net1314080903221.this);
