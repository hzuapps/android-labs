 ...
 */
public class Net1314080903207CalendarAdapter extends BaseAdapter {
...
//	private static String week[] = {"周日","周一","周二","周三","周四","周五","周六"};
	private Net1314080903207SpecialCalendar sc = null;
	private Net1314080903207LunarCalendar lc = null; 
	...
	public Net1314080903207CalendarAdapter(){
		Date date = new Date();
	...
	public Net1314080903207CalendarAdapter(Context context,Resources rs,int jumpMonth,int jumpYear,int year_c,int month_c,int day_c){
		this();
		this.context= context;
		sc = new Net1314080903207SpecialCalendar();
		lc = new Net1314080903207LunarCalendar();
		this.res = rs;
	...
	public Net1314080903207CalendarAdapter(Context context,Resources rs,int year, int month, int day){
		this();
		this.context= context;
		sc = new Net1314080903207SpecialCalendar();
		lc = new Net1314080903207LunarCalendar();
