...
class Adapter_LS_Net1314080903221 extends BaseAdapter
{
  ...
  public Adapter_LS_Net1314080903221(Context paramContext, List<Map<String, Object>> paramList, Map<Integer, Boolean> paramMap)
  {
