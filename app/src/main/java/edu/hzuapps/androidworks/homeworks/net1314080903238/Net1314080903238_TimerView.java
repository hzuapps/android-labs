...
public class Net1314080903238_TimerView extends LinearLayout {

	public Net1314080903238_TimerView(Context context, AttributeSet attrs) {
		super(context, attrs);
	}

	public Net1314080903238_TimerView(Context context) {
		super(context);
	}
