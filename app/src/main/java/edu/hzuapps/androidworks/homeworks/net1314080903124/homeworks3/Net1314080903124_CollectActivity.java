 ...
 * 
 */
public class Net1314080903124_CollectActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	private class QueryTask extends AsyncTask<Void, Void, ArrayList<Net1314080903124_CauseInfo>> {
		...
		protected ArrayList<Net1314080903124_CauseInfo> doInBackground(Void... params) {
			list = Net1314080903124_DBManager.getInstance(Net1314080903124_CollectActivity.this).query(Net1314080903124_CollectColumns.TABLE_NAME);
			return list;
		}
		...
		protected void onPostExecute(ArrayList<Net1314080903124_CauseInfo> list) {
			if (list.size() == 0) {
				Toast.makeText(Net1314080903124_CollectActivity.this, "您暂时没有收藏的题目", Toast.LENGTH_SHORT).show();
			...
			int lastSelect = Net1314080903124_ConfigPreferences.getInstance(Net1314080903124_CollectActivity.this).isLastSelectCollect();
			i = lastSelect - 1;
	...
	public void onClick(View v) {
		...
		case R.id.titlebar_right_text:
			Net1314080903124_DBManager.getInstance(this).removeAll(Net1314080903124_CollectColumns.TABLE_NAME);
			list.clear();
			subjectTop.setText("0/0");
			help.setText("");
			title.setText("");
		...
		case R.id.submit:
			if (isSelectA == false && isSelectB == false && isSelectC == false && isSelectD == false) {
				...
				if (isSelectA == true && isSelectB == true && isSelectC == false && isSelectD == false) {
					...
					Net1314080903124_DBManager.getInstance(this).update(Net1314080903124_CollectColumns.TABLE_NAME, myData);
		...
		case R.id.back:
			...
			if (isClickSelectSubject) {
				i = Net1314080903124_ConfigPreferences.getInstance(this).isLastSelectCollect() - 1;
				i -= 1;
				isClickSelectSubject = false;
			} else {
				i -= 1;
			}
			Net1314080903124_ConfigPreferences.getInstance(this).setLastSelectCollect(i + 1);
			list.clear();
			list = Net1314080903124_DBManager.getInstance(this).query(Net1314080903124_CollectColumns.TABLE_NAME);
		...
		case R.id.subject:
			listHasId = Net1314080903124_DBManager.getInstance(this).queryHasId(Net1314080903124_CollectColumns.TABLE_NAME);
		...
		case R.id.remove:
			...
			Net1314080903124_ConfigPreferences.getInstance(this).setLastSelectCollect(i + 1);
			list.clear();
			Net1314080903124_DBManager.getInstance(this).remove(Net1314080903124_CollectColumns.TABLE_NAME, myData);
			list = Net1314080903124_DBManager.getInstance(this).query(Net1314080903124_CollectColumns.TABLE_NAME);
			if ((i + 1) > list.size()) {
				i -= 1;
			}
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		list.clear();
		i = position;
		Net1314080903124_ConfigPreferences.getInstance(this).setLastSelectCollect(position + 1);
