...
public class MainActivity_Net1314080903221 extends TabActivity {
	private TabHost tabHost;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//setContentView(R.layout.activity_main___Net1314080903221);
		
		tabHost=getTabHost();
		Resources localResources = getResources();
		
		Intent localIntent2 = new Intent();
	    localIntent2.setClass(this, QueryBill_Net1314080903221.class);
	    ...
	    localIntent1.setClass(this, AddEvent_Net1314080903221.class);
	    ...
	    localIntent4.setClass(this, Shouru_Net1314080903221.class);
		...
		//LayoutInflater.from(this).inflate(R.layout.activity_main___Net1314080903221, tabHost.getTabContentView(), true);
        Intent localIntent3 = new Intent();
	    localIntent3.setClass(this, Shezhi_Net1314080903221.class);
