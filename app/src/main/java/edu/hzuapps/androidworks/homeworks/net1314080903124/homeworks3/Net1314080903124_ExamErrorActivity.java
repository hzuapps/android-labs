...
public class Net1314080903124_ExamErrorActivity extends Activity implements OnClickListener, OnItemClickListener {
	...
	private class QueryTask extends AsyncTask<Void, Void, ArrayList<Net1314080903124_CauseInfo>> {
		...
		protected ArrayList<Net1314080903124_CauseInfo> doInBackground(Void... params) {
			list = Net1314080903124_DBManager.getInstance(Net1314080903124_ExamErrorActivity.this).query(Net1314080903124_ExamErrorColumns.TABLE_NAME);
			return list;
		}
		...
		protected void onPostExecute(ArrayList<Net1314080903124_CauseInfo> list) {
			...
			int lastSelect = Net1314080903124_ConfigPreferences.getInstance(Net1314080903124_ExamErrorActivity.this).isLastExamError();
			i = lastSelect - 1;
			...
			case Net1314080903124_BaseColumns.NULL:
				...
				title.setText((i + 1) + "." + myData.timu_title);
				if ("单选".equals(myData.types)) {
			...
			case Net1314080903124_BaseColumns.AB:
				...
				rightAnswer.setText("正确答案："
						+ rightStr(getRightIntValue(myData.daan_one, myData.daan_tow,
								myData.daan_three, myData.daan_four)));
				break;
	...
	public void onClick(View v) {
		...
		case R.id.back:
			...
			if (isClickSelectSubject) {
				i = Net1314080903124_ConfigPreferences.getInstance(this).isLastExamError() - 1;
				i -= 1;
				isClickSelectSubject = false;
			} else {
				i -= 1;
			}
			Net1314080903124_ConfigPreferences.getInstance(this).setLastExamError(i + 1);
		...
		case R.id.subject:
			listHasId = Net1314080903124_DBManager.getInstance(this).queryHasId(Net1314080903124_ExamErrorColumns.TABLE_NAME);
		...
		case R.id.collect:
			myData.setReply(0);
			Net1314080903124_DBManager.getInstance(this).insert(Net1314080903124_ExamErrorColumns.TABLE_NAME, myData);
		...
		case R.id.forward:
			...
			case Net1314080903124_BaseColumns.AB:
				...
				imageTwo.setImageResource(R.drawable.more_select);
				rightAnswer.setText("正确答案："
						+ rightStr(getRightIntValue(myDataForward.daan_one, myDataForward.daan_tow,
								myDataForward.daan_three, myDataForward.daan_four)));
				break;
	...
	private class MyAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			case Net1314080903124_BaseColumns.AB:
				if (myData.reply == getRightIntValue(myData.daan_one, myData.daan_tow, myData.daan_three,
						myData.daan_four)) {
					tv.setBackgroundResource(R.color.select_right);
				} else {
					tv.setBackgroundResource(R.color.select_error);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		relFour.setBackgroundResource(R.color.select_default);
		i = position;
		Net1314080903124_ConfigPreferences.getInstance(this).setLastExamError(position + 1);
		...
		case Net1314080903124_BaseColumns.AB:
			...
			rightAnswer
					.setText("正确答案："
							+ rightStr(getRightIntValue(myData.daan_one, myData.daan_tow, myData.daan_three,
									myData.daan_four)));
			break;
	...
	protected void onDestroy() {
		super.onDestroy();
		Net1314080903124_ConfigPreferences.getInstance(this).setLastExamError(1);
	}
}
