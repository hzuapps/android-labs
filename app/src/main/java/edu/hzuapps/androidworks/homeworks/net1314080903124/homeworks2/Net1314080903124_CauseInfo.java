...
public class Net1314080903124_CauseInfo {
	...
	public Net1314080903124_CauseInfo(String timu_title, String timu_one, String timu_tow, String timu_three, String timu_four, String daan_one,
			String daan_tow, String daan_three, String daan_four, String detail, String types, int reply) {
		super();
		this.timu_title = timu_title;
		this.timu_one = timu_one;
		this.timu_tow = timu_tow;
	...
	public String toString() {
		return "Net1314080903124_CauseInfo [timu_title=" + timu_title + ", timu_one=" + timu_one + ", timu_tow=" + timu_tow + ", timu_three=" + timu_three
				+ ", timu_four=" + timu_four + ", daan_one=" + daan_one + ", daan_tow=" + daan_tow + ", daan_three=" + daan_three
				+ ", daan_four=" + daan_four + ", detail=" + detail + ", types=" + types + ", reply=" + reply + "]";
	}
	@Override
	public int hashCode() {
		final int prime = 31;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Net1314080903124_CauseInfo other = (Net1314080903124_CauseInfo) obj;
		if (daan_four == null) {
