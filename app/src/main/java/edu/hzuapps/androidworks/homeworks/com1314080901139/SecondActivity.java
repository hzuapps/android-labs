...
public class SecondActivity extends Activity implements ViewPager.OnPageChangeListener, RadarViewGroup.IRadarClickListener {
    ...
    private void setViewPagerSpeed(int duration) {
        try {
            ...
            scroller = new FixedSpeedScroller(SecondActivity.this, new AccelerateInterpolator());
    ...
    class ViewpagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(ViewGroup container, final int position) {
            ...
            //设置一大堆演示用的数据，麻里麻烦~~
            View view = LayoutInflater.from(SecondActivity.this).inflate(R.layout.viewpager_layout, null);
            ...
            ivPortrait.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(SecondActivity.this, "这是 " + info.getName() + " >.<", Toast.LENGTH_SHORT).show();
                }
            });
