 ...
 * 
 */
public class Net1214080613131CharacterParser {
	...
	private static Net1214080613131CharacterParser characterParser = new Net1214080613131CharacterParser();

	public static Net1214080613131CharacterParser getInstance() {
