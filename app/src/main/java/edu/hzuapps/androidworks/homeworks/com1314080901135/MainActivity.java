package edu.hzuapps.androidworks.homeworks.com1314080901135;
...
public class MainActivity extends Activity implements Runnable {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_com1314080901135_main);
	...
	private void refreshMarkList() {
		...
		SimpleAdapter simpleAdapter = new SimpleAdapter(this, data, R.layout.activity_com1314080901135_item, from, to);
