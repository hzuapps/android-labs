 ...
 * 
 */
public class Net1214080613131_CharacterParser {
	...
	private static Net1214080613131_CharacterParser characterParser = new Net1214080613131_CharacterParser();

	public static Net1214080613131_CharacterParser getInstance() {
